...
class PerformanceController(
    ...
    ): ResponseEntity<PerformanceDetailApiResponse> {
    ...
    @GetMapping("/list")
    fun getPerformanceByPaging(
        @RequestParam(defaultValue = "0") page: Int,
    ): ResponseEntity<PerformancePagingApiResponse> {
    ...
    fun getDiscount(
        @PathVariable performanceId: Long,
    ): ResponseEntity<List<PerformanceDiscountApiResponse>> {
    ...
    fun createPerformance(
        @RequestBody performanceCreateApiRequest: PerformanceCreateApiRequest,
    ): ResponseEntity<PerformanceDetailApiResponse> {
